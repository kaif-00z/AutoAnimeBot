...
from database import DataBase, LOGS
from traceback import format_exc
import asyncio, anitopy, hashlib, os
...
class SubsPlease:
    ...
    def feed_optimizer(self):
        ...
        for i in range(3,-1, -1):
            ...
            a1080, a720 = (anitopy.parse(f1080.title)).get("anime_title"), (anitopy.parse(f720.title)).get("anime_title")
            if a1080 == a720:
